...
namespace Project_Dr_Sara.Migrations
{
    /// <inheritdoc />
    public partial class FixSomeerror : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    SpecializationNavId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Doctors_Specializations_SpecializationNavId",
                        column: x => x.SpecializationNavId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctors_SpecializationNavId",
                table: "Doctors",
                column: "SpecializationNavId");
